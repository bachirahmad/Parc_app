...
<div style="color: #92a8d1; margin-left: 330px; "> <h1> </h1>
        	...
        	<div class="pull-right">
        		<a href="{{url('/voiture_create')}}" class="btn btn-success" > Nouvelle voiture </a> <br><br>
        	<div class="row">
  ...
  <div class="col-sm-6 col-md-4">
    <div class="thumbnail">
      ...
      <div class="caption">
        ...
        <p>...</p>
        <p>
    <a href="{{ url('voitures/detail/' . $voiture->id) }}" class="btn btn-info" role="button" style="margin-right: 150px">Detail</a> 
</p>
      </div>
    </div>
  </div>
